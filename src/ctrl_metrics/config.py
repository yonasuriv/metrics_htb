...
from ctrl_metrics.paths import TEMPLATES_DIR as _ASSETS
from ctrl_metrics.paths import default_cache_dir, default_output_dir
...
def resolve_auth_token(
    *,
    ...
    from ctrl_config.auth import resolve_auth_token as _resolve
...
def load_config(args: list[str] | None = None) -> Config:
    ...
    if env_profile is not None and len(str(env_profile)) != 6:
        env_profile = None
